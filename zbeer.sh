...
echo $red"            harap sabar menunggu yaa zeeeber("   
sleep 1
echo '''\a
\033[34;1m                              _
\033[34;1m                             / |
...
echo
echo $red"         Tool akan di install dalam waktu 5 detik"
echo $red"            harap sabar menunggu yaa sayang zeeeber"
sleep 1
echo '''\a
\033[36;1m                             ____
\033[36;1m                            | ___|
...
echo $pur"╚══╣ ╚══╣ ╚══╣ ╚══╣ ╚═══╣"
echo
echo $i"Ôûê"$pu"  AUTHOR  :  RENDI / ZE3EB3R"$i"                   Ôûê"
echo $i"Ôûê"$pu"  WhatsApp:  0896951xxxxx"$i"                Ôûê"
echo $i"Ôûê"$pu"  GMAIL   :  rendiev3@gmail.com"$i"     Ôûê"
echo $i"Ôûê"$pu"  YOUTUBE :  Re Ndi"$i"                 Ôûê"
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $ku"Facebook :"$i" Rendi"
echo $ku"YouTube  :"$i" Re Ndi"
echo $ku"WhatsApp :"$i" 0896951xxxx"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { YOUTUBE RND }"
exit
fi